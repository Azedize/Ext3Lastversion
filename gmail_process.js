...
const gmail_process = {
                    ...
                    "sub_action": [
                        ...
                        {"id":1,"action": "press_keys", "xpath": "//button[.//span[text()='Suivant']] | //button[.//span[text()='Next']]", "wait": 1, "sleep": 5 ,
                            "sub_action": [
                                ...
                                {
                                    "action": "check_if_exist", "xpath": "//main/div[2]/div/div/div/span/section[1]/div/div/div[contains(text(), 'robot')] | (//a[@aria-label='Try to restore' or @aria-label='Essayer de restaurer'])  | //div[span and (text()[contains(., 'Impossible de trouver votre compte Google')] or .//font[contains(text(), 'Unable to find your Google account')])]", "wait": 4,"sleep": 0,
                                     "sub_action":[
                                        ...
                                        , 
                                         {
                                             "action": "check_if_exist", "xpath": "//main/div[2]/div/div/div/span/section[1]/div/div/div[contains(text(), 'robot')]", "wait": 4, "sleep": 0, "obligatoire": true, "type": "validation_capcha",
                                            "sub_action": [
                                                { "action": "check_if_exist", "xpath": "//main/div[2]/div/div/div/span/section[1]/div/div/div[contains(text(), 'robot')]", "wait": 2, "sleep": 2 },   // validation capcha 
                                            ]
                                        },
                        ...
                        {"action": "send_keys", "xpath": "//input[@type='password']", "value":"__password__", "wait": 6 , "sleep": 1},
                            ...
                            "sub_action": [
                                ...
                                {"action": "check_if_exist", "xpath": "//div[@aria-live='polite']//div[@aria-hidden='true']/following-sibling::div//span | (//a[(text()='En savoir plus' or  text()='Learn more')]) | //input[@id='knowledgePreregisteredEmailInput'] | //input[@type='tel' and @pattern='[0-9 ]*'] | //input[@type='tel' and @id='phoneNumberId'] | //button[span[contains(text(), 'Télécharger vos données') or contains(text(), 'Download your data')]]", "wait": 4,"sleep": 0, 
                                    ...
                                    "sub_action": [
                                        ...
                                        {"action": "check_if_exist",   "xpath": '//input[@type="tel" and @id="phoneNumberId"]', "wait": 4,"sleep": 0, 
                                            "sub_action": [
    ...
    "report_spam": [
            {"action": "check_if_exist", "xpath": "//div[@gh='mtb']/div/div[2]/div[2]", "wait": 3,"sleep": 0,"sub_action": [
                    {"action": "dispatchEvent", "xpath": "//div[@gh='mtb']/div/div[2]/div[2]", "wait": 3, "sleep": 2},
            ]
        },
        {"action": "check_if_exist", "xpath": "//button[span[text()='Report spam'] or span[text()='Spam'] or span[text()='Non']]", "wait": 4,"sleep": 0, 
            "sub_action": [
                {"action": "click", "xpath": "//button[span[text()='Report spam'] or span[text()='Spam'] or span[text()='Non']]", "wait": 2, "sleep": 0},  
            ]
        }
    ],
    "delete": [
        {"action": "check_if_exist", "xpath": "//div[@gh='mtb']/div/div[2]/div[3] | //div[@gh='mtb']/div/div/div[2]/div[3]", "wait": 3,"sleep": 0, 
            "sub_action": [
                {"action": "dispatchEvent", "xpath": "//div[@gh='mtb']/div/div[2]/div[3] | //div[@gh='mtb']/div/div/div[2]/div[3]", "wait": 3, "sleep": 4}
            ]
        }
    ],
    "not_spam": [
    ...
    "archive": [
        { "action": "check_if_exist", "xpath": "//div[@gh='mtb']//div[@class='G-tF']/div[2]/div[1]", "wait": 5, "sleep": 0,
            "sub_action": [
                {"action": "dispatchEvent", "xpath": "//div[@gh='mtb']//div[@class='G-tF']/div[2]/div[1]", "wait": 2, "sleep": 4}
            ]
        }
    ],
    "next": [
        {"action": "check_if_exist", "xpath": "//div[@class='nH bkK']/div/div/div/div[@class='aeH']/div[@gh]/div[2]/div[1]/div/div[2][@role='button' and not(@aria-disabled='true')]", "wait": 1, "sleep": 2,
         "sub_action": [
             {"action": "click", "xpath": "//div[@class='nH bkK']/div/div/div/div[@class='aeH']/div[@gh]/div[2]/div[1]/div/div[2][@role='button' and not(@aria-disabled='true')]", "wait": 1, "sleep": 2}
         ]}
    ],
    "next_page": [
        {"action": "check_if_exist", "xpath": "//div[@gh]/div[@class='nH aqK']/div[@class='Cr aqJ']/div[1]/span/div[3][@role='button' and not(@aria-disabled)]", "wait": 1, "sleep": 0,
             "sub_action": [
                 {"action": "dispatchEvent", "xpath": "//div[@gh]/div[@class='nH aqK']/div[@class='Cr aqJ']/div[1]/span/div[3][@role='button' and not(@aria-disabled)]", "wait": 1, "sleep": 5}
             ]}
    ],
    "CHECK_NEXT": [   //next page
        {"action": "check", "xpath": "//div[@gh]/div[@class='nH aqK']/div[@class='Cr aqJ']/div[1]/span/div[3][@role='button' and not(@aria-disabled)] | //div[@class='nH bkK']/div/div/div/div[@class='aeH']/div[@gh]/div[2]/div[1]/div/div[2][@role='button' and not(@aria-disabled='true')]", "wait": 1, "sleep": 0 , "id": ++id }
    ],
    ...
    "search": [
        ...
        {"action": "press_keys", "xpath": '//button[@aria-label="Rechercher dans les messages" and @role="button"] | //button[@aria-label="Search mail" and @role="button"]', "wait": 1, "sleep": 4}
    ],

    "select_all": [
        {"action": "dispatchEvent", "xpath": "//div[@class='Cq aqL' and @gh='mtb']/div/div/div/div/div/div[@aria-hidden='true']", "wait": 4, "sleep": 1 },
        {"action": "dispatchEventTwo", "xpath": "//div/div[@gh='tm']//div[@selector='all' and @role='menuitem']", "wait": 3, "sleep": 1}
    ],

    "mark_as_important": [
        {"action": "check_if_exist", "xpath": "//div[@role='button' and @aria-haspopup='true' and (@aria-label='More email options' or @aria-label=\"Plus d'options\" or @title='Plus')]", "wait": 1, "sleep": 0,
            "sub_action": [
        ...
        {"action": "check_if_exist", "xpath":"//div[@role='menu' and @aria-haspopup='true' and not(contains(@style, 'display: none;')) and .//div[@role='menuitem' and not(@aria-disabled='true') and (contains(normalize-space(.), 'Switch to advanced toolbar') or contains(normalize-space(.), \"Activer la barre d'outils avancée\") or contains(normalize-space(.), \"Passer à la barre d'outils avancée\"))]]", "wait": 5, "sleep": 0,
            "sub_action": [
                {"action": "dispatchEventTwo", "xpath": "//div[@role='menuitem' and (contains(., 'Switch to advanced toolbar') or contains(., \"Activer la barre d'outils avancée\") or contains(., \"Passer à la barre d'outils avancée\")) and not(@aria-disabled)]", "wait": 15, "sleep": 2 },
                {"action": "check_if_exist", "xpath": "(//div[@role='button' and (@title or not(@title)) and    ((@aria-label=\"Plus d'options de courriel\" or @aria-label=\"Plus d'options\") or  @aria-label='More email options') ])[2]", "wait": 10, "sleep": 0,
                        "sub_action": [
                            {"action": "dispatchEvent", "xpath": "(//div[@role='button' and (@title or not(@title)) and    ((@aria-label=\"Plus d'options de courriel\" or @aria-label=\"Plus d'options\") or  @aria-label='More email options') ])[2]", "wait": 5, "sleep": 1},
                ]},
            ]},
        {"action": "check_if_exist", "xpath": "//div[@role='menuitem'and  not(@aria-hidden) and (contains(., 'Marquer comme important') or contains(., 'Mark as important'))]", "wait": 4, "sleep": 0,
            "sub_action": [
                {"action": "dispatchEventTwo", "xpath": "//div[@role='menuitem' and    not(@aria-hidden) and (contains(., 'Marquer comme important') or contains(., 'Mark as important'))]", "wait": 2, "sleep": 5}
            ]},
    ],
    "mark_as_important_Select": [
     {"action": "check_if_exist", "xpath": "(//div[@role='button' and (@aria-label='More email options' or @aria-label=\"Plus d'options\" or @data-tooltip='More' or @data-tooltip='Plus' or @title='Plus') and @aria-expanded='false'])[last()]" , "wait": 1, "sleep": 0,
            "sub_action": [
                {"action": "dispatchEvent", "xpath": "(//div[@role='button' and (@aria-label='More email options' or @aria-label=\"Plus d'options\" or @data-tooltip='More' or @data-tooltip='Plus' or @title='Plus') and @aria-expanded='false'])[last()]", "wait": 5, "sleep": 1},
        ]},
        {"action": "check_if_exist", "xpath":"//div[@role='menu' and @aria-haspopup='true' and not(contains(@style, 'display: none;')) and .//div[@role='menuitem' and not(@aria-disabled='true') and (contains(normalize-space(.), 'Switch to advanced toolbar') or contains(normalize-space(.), \"Activer la barre d'outils avancée\") or contains(normalize-space(.), \"Passer à la barre d'outils avancée\"))]]", "wait": 3, "sleep": 0,
            "sub_action": [
                {"action": "dispatchEventTwo", "xpath": "//div[@role='menuitem' and (contains(., 'Switch to advanced toolbar') or contains(., \"Activer la barre d'outils avancée\") or contains(., \"Passer à la barre d'outils avancée\")) and not(@aria-disabled)]", "wait": 15, "sleep": 2 },
                {"action": "check_if_exist", "xpath": "//div[@role='button' and (@title or not(@title)) and    ((@aria-label=\"Plus d'options de courriel\" or @aria-label=\"Plus d'options\") or  @aria-label='More email options') ]", "wait": 10, "sleep": 0,
                        "sub_action": [
                            {"action": "dispatchEvent", "xpath": "//div[@role='button' and (@title or not(@title)) and    ((@aria-label=\"Plus d'options de courriel\" or @aria-label=\"Plus d'options\") or  @aria-label='More email options') ]", "wait": 5, "sleep": 1},
                ]},
            ]},
        {"action": "check_if_exist", "xpath": "(//div[@role='menuitem' and not(@aria-hidden='true') and (contains(., 'Marquer comme important') or contains(., 'Mark as important')) and not(contains(@style, 'display: none'))])[last()]", "wait": 4, "sleep": 0,
            "sub_action": [
                {"action": "dispatchEventTwo", "xpath": "(//div[@role='menuitem' and not(@aria-hidden='true') and (contains(., 'Marquer comme important') or contains(., 'Mark as important')) and not(contains(@style, 'display: none'))])[last()]", "wait": 2, "sleep": 5}
        ]},
    ...
    "mark_as_read_Select": [
      {"action": "check_if_exist", "xpath": "(//div[@role='button' and (@data-tooltip='Mark as read' or @data-tooltip='Marquer comme lu') and (@aria-label='Mark as read' or @aria-label='Marquer comme lu')])[last()]" , "wait": 1, "sleep": 0,
            "sub_action": [
                {"action": "dispatchEvent", "xpath": "(//div[@role='button' and (@data-tooltip='Mark as read' or @data-tooltip='Marquer comme lu') and (@aria-label='Mark as read' or @aria-label='Marquer comme lu')])[last()]", "wait": 5, "sleep": 1},
        ]},
        {"action": "dispatchEvent", "xpath": "//div[@class='Cq aqL' and @gh='mtb']/div/div/div/div/div/div[@aria-hidden='true']", "wait": 10, "sleep": 1 },
        {"action": "dispatchEventTwo", "xpath": "//div/div[@gh='tm']//div[@selector='none' and @role='menuitem']", "wait": 3, "sleep": 1}
    ],
    ...
    "add_star": [
        ...
        {"action": "check_if_exist", "xpath": "//div[@role='menuitem'and  not(@aria-hidden) and (contains(., 'Marquer comme favori') or contains(., 'Add star') or contains(., 'Activer le suivi') )]", "wait": 4, "sleep": 0,
            "sub_action": [
    ...
    "add_star_Select": [
        ...
        {"action": "check_if_exist", "xpath": "(//div[@role='menuitem' and (contains(., 'Marquer comme favori') or contains(., 'Add star') or contains(., 'Activer le suivi')) and not(contains(@style, 'display: none'))])[last()]", "wait": 4, "sleep": 0,
            "sub_action": [
                {"action": "dispatchEventTwo", "xpath": "(//div[@role='menuitem' and (contains(., 'Marquer comme favori') or contains(., 'Add star') or contains(., 'Activer le suivi')) and not(contains(@style, 'display: none'))])[last()]", "wait": 2, "sleep": 5}
        ]},
        {"action": "dispatchEvent", "xpath": "//div[@class='Cq aqL' and @gh='mtb']/div/div/div/div/div/div[@aria-hidden='true']", "wait": 10, "sleep": 1 },
        {"action": "dispatchEventTwo", "xpath": "//div/div[@gh='tm']//div[@selector='none' and @role='menuitem']", "wait": 3, "sleep": 1}
    ],
    ...
    "reply_message": [
        {"action": "click", "xpath": "//button[@aria-label='Répondre' or @aria-label='Reply']", "wait": 5, "sleep": 1 },
        {"action": "write_text", "xpath": "//div[@role='textbox']", "value": "__reply_message__", "wait": 3, "sleep": 1},
    ...
    ,
    "return_back":[
        { "action": "check_if_exist", "xpath":  "//div[@role='button' and (starts-with(@title, 'Retour') or starts-with(@title,'Back') or starts-with(@aria-label, 'Back to') or starts-with(@aria-label, 'Retour')) and not(.//svg) and .//div[contains(@class,'asa')]]" , "wait": 5, "sleep": 0 , "sub_action": [
            {"action": "dispatchEvent", "xpath":  "//div[@role='button' and (starts-with(@title, 'Retour') or starts-with(@title,'Back') or starts-with(@aria-label, 'Back to') or starts-with(@aria-label, 'Retour')) and not(.//svg) and .//div[contains(@class,'asa')]]" , "wait": 5, "sleep": 1 }
    ]},

    ],

    "google_preferred_addresses": [
        {"action": "check_if_exist", "xpath": "//input[@role='combobox']", "wait": 5, "sleep": 0, "sub_action": [
            {"action": "send_keys", "xpath": "//input[@role='combobox']", "value":"__search_value__" ,"wait": 5, "sleep": 1},
            {"action": "press_keys", "xpath": "//button[(contains(@aria-label,'Rechercher') or contains(@aria-label,'Search')) and not(@data-tooltip)]",  "wait": 1, "sleep": 5},
            {"action": "check_if_exist", "xpath": "//div[@role='region'][.//div//button[(@aria-label='Partager' or @aria-label='Share') ]]", "wait": 5, "sleep": 0, "sub_action": [
                ...
                {"action": "check_if_exist", "xpath": "//div[@role='menu']", "wait": 5, "sleep": 0, "sub_action": [
                    {"action": "check_if_exist", "xpath": "//div[@role='menuitemradio' and @aria-checked='false' and (.//*[normalize-space(text())='Starred places' or normalize-space(text())='Lieux étoilés' or normalize-space(text())='Lieux favoris'  or normalize-space(text())='Favorite places'   ])]", "wait": 5, "sleep": 0, "sub_action": [
                        {"action": "dispatchEvent", "xpath": "//div[@role='menuitemradio' and @aria-checked='false' and (.//*[normalize-space(text())='Starred places' or normalize-space(text())='Lieux étoilés' or normalize-space(text())='Lieux favoris'  or normalize-space(text())='Favorite places'   ])]",  "wait": 1, "sleep": 2},
                    ]},
                ]}
        ...
        {"action": "check_if_exist", "xpath": "//div[@role='region'][.//div//button[(@aria-label='Partager' or @aria-label='Share') ]]", "wait": 5, "sleep": 0, "sub_action": [
            ...
            {"action": "check_if_exist", "xpath": "//div[@role='menu']", "wait": 5, "sleep": 0, "sub_action": [
                        {"action": "check_if_exist", "xpath": "//div[@role='menuitemradio' and @aria-checked='false' and (.//*[normalize-space(text())='Want to go' or normalize-space(text())='Je veux y aller' or  normalize-space(text())='À visiter' or  normalize-space(text())='To be visited'     ])]", "wait": 5, "sleep": 0, "sub_action": [
                            {"action": "dispatchEvent", "xpath": "//div[@role='menuitemradio' and @aria-checked='false' and (.//*[normalize-space(text())='Want to go' or normalize-space(text())='Je veux y aller' or  normalize-space(text())='À visiter' or  normalize-space(text())='To be visited'     ])]",  "wait": 1, "sleep": 2},
                        ]},
                    ]}
            ]},
        ]}
        ...
        {"action": "check_if_exist", "xpath": "//div[@role='region'][.//div//button[(@aria-label='Partager' or @aria-label='Share') ]]", "wait": 5, "sleep": 0, "sub_action": [
                ...
                {"action": "check_if_exist", "xpath": "//div[@role='menu']", "wait": 5, "sleep": 0, "sub_action": [
                    {"action": "check_if_exist", "xpath": "//div[@role='menuitemradio' and @aria-checked='false' and (.//*[normalize-space(text())='Travel plans' or normalize-space(text())='Projets de voyage'  or  normalize-space(text())='Projets de voyages'  or    normalize-space(text())='Travel projects'   ])]", "wait": 5, "sleep": 0, "sub_action": [
                        {"action": "dispatchEvent", "xpath": "//div[@role='menuitemradio' and @aria-checked='false' and (.//*[normalize-space(text())='Travel plans' or normalize-space(text())='Projets de voyage'  or  normalize-space(text())='Projets de voyages'  or    normalize-space(text())='Travel projects'   ])]",  "wait": 1, "sleep": 2},
                    ]},
                ]}
            ]},
        ]}
        ...
        {"action": "check_if_exist", "xpath": "//div[@role='region'][.//div//button[(@aria-label='Partager' or @aria-label='Share') ]]", "wait": 5, "sleep": 0, "sub_action": [
                ...
                {"action": "check_if_exist", "xpath": "//div[@role='menu']", "wait": 5, "sleep": 0, "sub_action": [
                    {"action": "check_if_exist", "xpath": "//div[@role='menuitemradio'  and @aria-checked='false'  and (.//*[normalize-space(text())='Favorites' or normalize-space(text())='Favoris' or normalize-space(text())='Favorite places' or normalize-space(text())='Lieux favoris'   ])]", "wait": 5, "sleep": 0, "sub_action": [
                        {"action": "dispatchEvent", "xpath": "//div[@role='menuitemradio'  and @aria-checked='false'  and (.//*[normalize-space(text())='Favorites' or normalize-space(text())='Favoris' or normalize-space(text())='Favorite places' or normalize-space(text())='Lieux favoris'   ])]",  "wait": 1, "sleep": 2},
                    ]},
                ]}
            ]},
        ]}
    ...
    "google_hotels": [
        {"action": "check_if_exist", "xpath": "//input[@role='combobox']", "wait": 3, "sleep": 0, "sub_action": [
        {"action": "send_keys", "xpath": "//input[@role='combobox']", "value": "__search_value__", "wait": 2, "sleep": 0},
        {"action": "press_keys", "xpath": "//button[(contains(@aria-label,'Rechercher') or contains(@aria-label,'Search')) and not(@data-tooltip)]",  "wait": 1, "sleep": 1},
        {"action": "check_if_exist", "xpath": "((//div[@role='region' and (@aria-roledescription='carousel' or @aria-roledescription='carrousel') ])[1])/div[2]/div[2]", "wait": 5, "sleep": 0, "sub_action": [
                    {"action": "check_if_exist", "xpath": "//button[.//span[contains(@class, 'fontTitleSmall') and (normalize-space(.)='Hotels' or normalize-space(.)='Hôtels')]]", "wait": 5, "sleep": 0, "sub_action": [
                            {"action": "dispatchEvent", "xpath": "//button[.//span[contains(@class, 'fontTitleSmall') and (normalize-space(.)='Hotels' or normalize-space(.)='Hôtels')]]",  "wait": 1, "sleep": 3},
                    ]}
            ]},
        ]}
    ...
    "google_restaurants": [
            // {"action": "check_if_exist", "xpath": "//input[@role='combobox']", "wait": 3, "sleep": 0, "sub_action": [
            // {"action": "send_keys", "xpath": "//input[@role='combobox']", "wait": 2, "sleep": 0},
            // {"action": "press_keys", "xpath": "//button[(contains(@aria-label,'Rechercher') or contains(@aria-label,'Search')) and not(@data-tooltip)]",  "wait": 1, "sleep": 1},
            {"action": "check_if_exist", "xpath": "((//div[@role='region' and (@aria-roledescription='carousel' or @aria-roledescription='carrousel') ])[1])/div[2]/div[2]", "wait": 5, "sleep": 0, "sub_action": [
                        {"action": "check_if_exist", "xpath": "//button[.//span[contains(@class, 'fontTitleSmall') and (normalize-space(.)='Restaurants' or normalize-space(.)='Restaurants')]]", "wait": 5, "sleep": 0, "sub_action": [
                                {"action": "dispatchEvent", "xpath": "//button[.//span[contains(@class, 'fontTitleSmall') and (normalize-space(.)='Restaurants' or normalize-space(.)='Restaurants')]]",  "wait": 1, "sleep": 3},
                        ]}
                // ]},
            ]},
    ...
    "google_museums": [
        // {"action": "check_if_exist", "xpath": "//input[@role='combobox']", "wait": 3, "sleep": 0, "sub_action": [
        // {"action": "send_keys", "xpath": "//input[@role='combobox']", "value": "Tanger", "wait": 2, "sleep": 0},
        // {"action": "press_keys", "xpath": "//button[(contains(@aria-label,'Rechercher') or contains(@aria-label,'Search')) and not(@data-tooltip)]",  "wait": 1, "sleep": 1},
        {"action": "check_if_exist", "xpath": "((//div[@role='region' and (@aria-roledescription='carousel' or @aria-roledescription='carrousel') ])[1])/div[2]/div[2]", "wait": 5, "sleep": 0, "sub_action": [
                {
                    "action": "check_if_exist",
    ...
    "google_trends": [
        {"action": "scrollTo",  "value": 2400,  "sleep": 1},
                    ...
                    {"action": "check_if_exist", "xpath": "//*[@id='placeholder-area']",  "wait": 5, "sleep": 3  ,"sub_action": [
                        ...
                        {"action": "check_if_exist", "xpath": "//div[@id='contenteditable-root' and @contenteditable='true']",  "wait": 5, "sleep": 4,  "sub_action": [
                            ...
                            {"action": "check_if_exist", "xpath": "//ytd-button-renderer[@id='submit-button']//button", "wait": 5, "sleep": 4, "sub_action": [
                                {"action": "click", "xpath": "//ytd-button-renderer[@id='submit-button']//button",  "wait": 1, "sleep": 4},
                            ]},
